...
public class Main{
    public static void main(String[] args) {
        ...
        // 방법3: 책꽃이에 반복자(iterator)를 만들어서 책을 꺼내는 방식 (for-each문)
        // 형식: for (타입 변수명 : 컬렉션) { ... }
        for (Book b : bookShelf) { // Iterable 인터페이스를 구현했기 때문에 for-each문에서 사용할 수 있음
